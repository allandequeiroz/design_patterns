Accounts.emailTemplates.setNamed = "Meteor in Action userApp";
Accounts.emailTemplates.from = "Allan <allandequeiroz@gmail.com>";
Accounts.emailTemplates.verifyEmail.subject = function(user){
    return 'Confirm Your Email Address, ' + user.username
};
Accounts.emailTemplates.verifyEmail.text = function(user, url){
    return "Welcome to the Meteor in Action userApp!\n" +
            "To verify you email address go ahead and follow the link below:\n\n" +
            url;
};
